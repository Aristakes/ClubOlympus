...
public class AddMemberActivity extends AppCompatActivity  implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private  void saveMember(){
        ...
        if (TextUtils.isEmpty(firstName)) {
            ...
            Toast.makeText(this , "Input the firstName" , Toast.LENGTH_LONG).show();
            return;

        }else if (TextUtils.isEmpty(lastName)){

            Toast.makeText(this , "Input the lastName" , Toast.LENGTH_LONG).show();
            return;
        ...
        if (currentMemberUri == null) {
           ...
           int rowsChanged =  getContentResolver().update(currentMemberUri , contentValues ,
                   null , null);
           if(rowsChanged == 0){
               Toast.makeText(this , "Saving of the data in the table failed" ,
                       Toast.LENGTH_LONG).show();
           }else {
    ...
    private void showDeleteMemberDialog() {
        ...
        builder.setMessage("Do you thant delete the Member");
